...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  data: function data() {
    return {
      loginForm: new vform__WEBPACK_IMPORTED_MODULE_1__.default({
        email: '',
        password: ''
      })
    };
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                axios__WEBPACK_IMPORTED_MODULE_2___default().post('/api/auth/login', _this.loginForm).then(function (res) {
                ...
                _c(
                  ...
                  [
                    _c("div", { staticClass: "form-group" }, [
                      ...
                      _vm._v(" "),
                      _c("span", {
                        attrs: { form: _vm.loginForm, field: "email" }
                      })
                    ]),
                    _vm._v(" "),
                    _c("div", { staticClass: "form-group" }, [
                      ...
                      _vm._v(" "),
                      _c("span", {
                        attrs: { form: _vm.loginForm, field: "password" }
                      })
                    ]),
                    _vm._v(" "),
                    _c("div", { staticClass: "form-group" }, [
