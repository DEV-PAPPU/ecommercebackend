        ...
        <div class="admin">
            <nav class="sidebar bg-white shadow-lg" id="sidebar">
                ...
                <ul class="mt-2">
                    ...
                    <li>
                        <router-link :to="{name: 'all-users'}" class="">
                            <i class="las la-user-secret"></i><span class="menuText">Users</span></router-link>
                    </li>
                    <li>
                        <router-link :to="{name: 'orders'}" class="">
                            <i class="las la-cart-arrow-down"></i><span class="menuText">Orders</span></router-link>
                    </li>

                    <li>
                        <router-link :to="{name: 'product-create'}" class="">
                            <i class="las la-hand-point-right"></i><span class="menuText">Add Product</span>
                        </router-link>
                    </li>
                    <li>
                        <router-link :to="{name: 'category'}" class="">
                            <i class="las la-hand-point-right"></i><span class="menuText">Category List</span>
                        </router-link>
                    </li>
                    <li>
                        <router-link :to="{name: 'product-lists'}" class="">
                            <i class="las la-hand-point-right"></i><span class="menuText">All Products</span>
                        </router-link>
                    </li>
...
import AdminDashboad from './pages/dashboard.vue'
    export default {
...
@import "../../../../public/website/css/tailwind";
*body {
    margin: 0;
    padding: 0;
