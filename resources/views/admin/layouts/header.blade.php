        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          @if (Route::has('login'))
                <div class="hidden sm:block">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="dropdown-item"><i class="fas fa-users mr-2"></i> Dashboard</a>
                       
                    @else
                        <a href="{{ route('login') }}" class="dropdown-item"><i class="fas fa-users mr-2"></i> Log </a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="dropdown-item"><i class="fas fa-users mr-2"></i> Register </a>
                        @endif
                    @endauth
                </div>
             @endif
