        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
              <!-- <router-link :to="{name: 'category'}" class="nav-link">Category List</router-link> -->
              </li>
            </ul>
          </li>
          <li class="nav-item">
          <router-link :to="{name: 'order'}" class="nav-link">
                <i class="nav-icon fas fa-th"></i> Orders <span class="right badge badge-danger">New</span></router-link>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                ...
                <i class="far fa-circle nav-icon"></i> Category List</router-link>

              </li>

              <li class="nav-item">
                <router-link :to="{name: 'product-lists'}" class="nav-link">
                <i class="far fa-circle nav-icon"></i>All Products</router-link>
              </li>
            </ul>
          </li>
        </ul>
